...
| 7 | Tickets ✅ · metrics and customers ✗ | Partial | Partial |
| 8 | KPI dashboard | ✗ | ✗ |
...
Onboarding checklists, a compliance register, MRR/churn metrics, the customer base, and the audit log are the named gaps.
